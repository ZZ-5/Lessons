...
// eslint: анализирует js, подсказывает ошибки. Конфигурация правил задается в файле .eslintrc.[json/js/yml]

// tslint: анализирует ts, подсказывает ошибки. Конфигурация правил задается в файле tslint.[json/yml]
