...
// Как мы помним, на каждый новый вызов функции создается Function Execution context, который кладётся вверх Call stack-а. В FEC есть привязанный this, LexicalEnvironment и VariableEnvironment.
...
// когда у функции нет своей переменной она ищет ее во внешнем лексическом окружении
// function sum(param1) {
//   let a = param1;
